...
public class Document {
    ...
    @SerializedName("is_approve_edit_request")
    @Expose
    private int documentapprove;


    public int getDocumentapprove() {
        return documentapprove;
    }

    public void setDocumentapprove(int documentapprove) {
        this.documentapprove = documentapprove;
    }
    ...
    public String toString() {
        return
                "Document{" +
                        ...
                        ",option = '" + option + '\'' +
                        ",is_approve_edit_request = '" + documentapprove + '\'' +
                        "}";
    }
}