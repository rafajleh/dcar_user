...
public class Triplocation {
    ...
    public void setGooglePathStartLocationToPickUpLocation(String
    ...
    public void setProviderStartToStartTripLocations(List<List<Double>>
    ...
    public void setGooglePickUpLocationToDestinationLocation(String
    ...
    public String toString() {
        return
                "Triplocation{" +
                        "trip_unique_id = '" + tripUniqueId + '\'' +
                        ",endTripTime = '" + endTripTime + '\'' +
                        ",endTripLocation = '" + endTripLocation + '\'' +
                        ",providerStartTime = '" + providerStartTime + '\'' +
                        ",providerStartToStartTripLocations = '" +
                        providerStartToStartTripLocations + '\'' +
                        ...
                        ",tripID = '" + tripID + '\'' +
                        ",_id = '" + id + '\'' +
                        ",providerStartLocation = '" + providerStartLocation + '\'' +
                        "}";
    }
}