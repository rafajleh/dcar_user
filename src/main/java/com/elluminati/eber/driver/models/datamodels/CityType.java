    ...
    public String toString() {
        return
                "CityType{" +
                        ...
                        ",price_for_total_time = '" + priceForTotalTime + '\'' +
                        ",base_price_distance = '" + basePriceDistance + '\'' +
                        ",is_buiesness = '" + isBuiesness + '\'' +
                        ",surge_start_hour = '" + surgeStartHour + '\'' +
                        ",cityname = '" + cityname + '\'' +
