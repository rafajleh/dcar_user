...
public class Provider {
    ...
    @SerializedName("is_end_of_trip")
    private boolean isCheckEndTrip;

    @SerializedName("end_of_trip_address")
    private String endTripAddress;

    @SerializedName("end_of_trip_Location")
    private List<Double> latlngEND;

    @SerializedName("is_topup_required")
    private int istopuprequired;


    public int getIstopuprequired() {
        return istopuprequired;
    }

    public void setIstopuprequired(int istopuprequired) {
        this.istopuprequired = istopuprequired;
    }

    public List<Double> getLatlngEND() {
        return latlngEND;
    }

    public void setLatlngEND(List<Double> latlngEND) {
        this.latlngEND = latlngEND;
    }

    public boolean getCheckEndTrip() {
        return isCheckEndTrip;
    }

    public void setCheckEndTrip(boolean checkEndTrip) {
        isCheckEndTrip = checkEndTrip;
    }
    ...
    public void setEndTripAddress(String endTripAddress) {
        this.endTripAddress = endTripAddress;
    }
    ...
    public String toString() {
        return
                "Provider{" +
                        ...
                        ",last_transfered_date = '" + lastTransferedDate + '\'' +
                        ...
                        ",login_by = '" + loginBy + '\'' +
                        ",is_end_of_trip = '" + isCheckEndTrip + '\'' +
                        ",end_of_trip_address = '" + endTripAddress + '\'' +
                        ",end_of_trip_Location = '" + latlngEND + '\'' +
