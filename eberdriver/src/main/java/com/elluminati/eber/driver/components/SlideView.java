...
public class SlideView extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    void init(AttributeSet attrs, int defStyle) {
        ...
        slideTextView = (MyFontTextView) findViewById(R.id.slideText);
        ivArrowImage = (ImageView) findViewById(R.id.ivArrowImage);
    ...
    public void setEnabled(boolean enabled) {
        ...
        SliderUtil.setDrawableColor(buttonBackground, buttonBackgroundColor.getColorForState(
                enabled ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}
                , ContextCompat.getColor(getContext(), R.color.color_app_button)));
        SliderUtil.setDrawableColor(slideBackground, slideBackgroundColor.getColorForState(
                enabled ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}
                , ContextCompat.getColor(getContext(), R.color.color_app_button)));
    }
