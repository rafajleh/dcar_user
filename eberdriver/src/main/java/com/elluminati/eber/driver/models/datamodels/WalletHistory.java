...
public class WalletHistory implements Parcelable {
    ...
    public static final Parcelable.Creator<WalletHistory> CREATOR = new Parcelable
            .Creator<WalletHistory>() {
        @Override
    ...
    public String toString() {
        return
                "WalletHistory{" +
                        "wallet_comment_id = '" + walletCommentId + '\'' +
                        ",unique_id = '" + uniqueId + '\'' +
